...
/**
 * Trapezoid MLP from NEUROPH package
 *
 * @author Artur Augustyniak <artur@aaugustyniak.pl>
 */
public class TrapezoidPerceptron extends MultiLayerPerceptron {

    public TrapezoidPerceptron(List<Integer> inLayers, NetworkParams p) {
